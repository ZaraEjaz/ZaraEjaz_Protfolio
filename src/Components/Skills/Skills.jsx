        ...
        <div className="row">
          <div className="col-lg-12">
            ...
            <li className="tech-stack-box" data-aos="fade-right">
                <img src="./Images/reactlogo.png" alt="React skill" className="tech-stack-logo" />
                <span className="tooltip">REACT</span>
              </li>
              <li className="tech-stack-box" data-aos="fade-left" data-aos-delay="900">
                <img src="./Images/Tailwind.png" alt="tailwind skill" className="tech-stack-logo" />
                <span className="tooltip">TAILWIND CSS</span>
              </li>
              <li className="tech-stack-box" data-aos="fade-right" data-aos-delay="200">
                <img src="./Images/Node.js.png" alt="js skill" className="tech-stack-logo" />
                <span className="tooltip">NODE JS</span>
              </li>
              <li className="tech-stack-box" data-aos="fade-left" data-aos-delay="400">
                <img src="./Images/Redux.png" alt="Redux skill" className="tech-stack-logo" />
              ...
              <li className="tech-stack-box" data-aos="fade-left" data-aos-delay="800">
                <img src="./Images/Express.png" alt="Express.js skill" className="tech-stack-logo" />
              ...
              <li className="tech-stack-box" data-aos="fade-left" data-aos-delay="800">
                <img src="./Images/MongoDB.png" alt="MongoDB skill" className="tech-stack-logo" />
